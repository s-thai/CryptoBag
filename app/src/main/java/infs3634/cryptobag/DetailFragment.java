...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mValue = v.findViewById(R.id.tvValueNameField);
        mChange1h = v.findViewById(R.id.tvChange1hNameField);
        mChange24h = v.findViewById(R.id.tvChange1DayNameField);
        mChange7d = v.findViewById(R.id.tvChange1WeekNameField);
        mMarketcap = v.findViewById(R.id.tvMarketcapNameField);
        mVolume = v.findViewById(R.id.tvVolumeNameField);
